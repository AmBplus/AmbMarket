...
{
    public class RequestSaveNewCatalogItemCmd : IRequest<ResultDto<long>>
    {
    ...
    public class AddNewCatalogItemDtoValidator: AbstractValidator<RequestSaveNewCatalogItemCmd>
    {
