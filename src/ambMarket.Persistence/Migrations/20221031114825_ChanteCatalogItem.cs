...
{
    public partial class ChanteCatalogItem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabeStock = table.Column<int>(type: "int", nullable: false),
                    RentStock = table.Column<int>(type: "int", nullable: false),
