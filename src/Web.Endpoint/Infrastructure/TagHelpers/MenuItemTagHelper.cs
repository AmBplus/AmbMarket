using ambMarket.Application.Services.Common.Query;
using MediatR;
using Microsoft.AspNetCore.Mvc.Rendering;
using Microsoft.AspNetCore.Razor.TagHelpers;

namespace Web.Endpoint.Infrastructure.TagHelpers
{
    
    public class MenuItemTagHelper : TagHelper
    {
        private IMediator Mediator { get; }
        public MenuItemTagHelper(IMediator mediator)
        {
            Mediator = mediator;
        }
        ...
        {
            output.TagName = "ul";
            output.Content.AppendHtml( await GetContent());
        }
        ...
        private async Task<TagBuilder> GetContent()
        {
            var data = (await Mediator.Send( new RequestGetMenuItemWebsite {})).MenuItemDtos;
